const features = [
  { name: "Category", description: "Web Application" },
  {
    name: "Back-End Technology",
    description: "ASP.NET Core or any suitable techonology.API based or MVC",
  },
  {
    name: "Front-End Technology(Client)",
    description:
      "Most powerful UI library 'React Js'. Or Framework like NextJs, React-Router7",
  },
  {
    name: "Front-End Technology(Admin)",
    description:
      "Most powerful UI library 'React Js'. Or Framework like NextJs, React-Router7",
  },
  { name: "Includes", description: "Both Web view and Mobile view" },
  {
    name: "Considerations",
    description: "A quality applications takes time.",
  },
];

export default function ServiceItem({ params }: any) {
