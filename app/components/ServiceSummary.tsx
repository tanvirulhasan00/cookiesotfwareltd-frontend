    ...
    <div className="bg-gray-50 py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-center text-base/7 font-semibold text-indigo-600 flex items-center justify-center">
          ...
          <Link
            to="/services"
            className="text-sm/6 font-semibold text-red-600 ml-10"
          >
            Read more
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)]">
              ...
              <div className="flex flex-1 items-center justify-center px-8 max-lg:pt-10 max-lg:pb-12 sm:px-10 lg:pb-2">
                <img
                  alt=""
                  src="/web.jpg"
                  className="w-full object-center h-[10rem] max-lg:max-w-xs"
                />
              </div>
            </div>
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)]">
              ...
              <div className="@container flex flex-1 items-center max-lg:py-6">
                <img
                  alt=""
                  src="mobile-2.jpg"
                  className="w-full h-[min(152px,40cqw)] object-cover rounded-b-sm"
                />
              </div>
            </div>
              ...
              <div className="relative min-h-120 w-full grow">
                <div className="absolute top-10 right-0 bottom-0 left-10 overflow-hidden rounded-tl-xl bg-gray-900 shadow-2xl outline outline-white/10">
                  ...
                  <div className="px-6 pt-6 pb-14">
                    {/* Your code example */}
                    <ul>
                      <li className="text-white list-disc">Front-end</li>
                      <li className="text-white list-disc">Back-end</li>
                      <li className="text-white list-disc">Powerful APIs</li>
                      <li className="text-white list-disc">
                        Dashboard for controll APIs
                      </li>
                    </ul>
                  </div>
                </div>
